...
Fix broken sync status (0 connected despite config), retry mechanism, and error page showing 0 errors. Add error timeline with drill-down.
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0224-dashboard-sync-and-error-drilling"
