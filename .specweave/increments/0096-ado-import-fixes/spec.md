...
Boards like `ai-platform`, `assetcare` appear at `specs/` root instead of inside the project folder (`specs/olysense/`).
...
// Creates: specs/olysense/software-maintenance-for-financial-year-26/
// Should be: specs/olysense/digital-service-operations/
```
...
```
specs/
├── olysense/                           # Project (from ADO project name)
