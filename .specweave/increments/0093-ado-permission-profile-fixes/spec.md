...
{
  "sync": {
    "activeProfile": "ado-olysense"  // Only ONE profile active
  }
}
```

This means:
- Sync nova-x-sandbox increment -> Uses olysense profile (WRONG)
- Sync olysense increment -> Uses olysense profile (OK)
- Sync nova-iomt increment -> Uses olysense profile (WRONG)
