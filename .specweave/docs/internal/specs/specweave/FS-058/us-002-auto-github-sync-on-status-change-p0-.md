...
external:
  github:
    issue: 743
    url: https://github.com/anton-abyzov/specweave/issues/743
---
...
- [x] [T-004](../../../../increments/0058-fix-status-sync-and-auto-github-update/tasks.md#T-004): Create StatusChangeSyncTrigger class
- [x] [T-006](../../../../increments/0058-fix-status-sync-and-auto-github-update/tasks.md#T-006): Integrate trigger into MetadataManager.updateStatus()
- [x] [T-010](../../../../increments/0058-fix-status-sync-and-auto-github-update/tasks.md#T-010): Integration tests for auto-sync
- [x] [T-011](../../../../increments/0058-fix-status-sync-and-auto-github-update/tasks.md#T-011): E2E test: Create → Activate → Complete → GitHub