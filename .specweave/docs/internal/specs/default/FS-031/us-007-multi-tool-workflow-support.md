...
- [x] **AC-US7-02**: Support custom workflow definitions (P3, testable)
- [x] **AC-US7-03**: Validate status transitions against workflow (P3, testable)
- [x] **AC-US7-04**: Suggest valid next states based on workflow (P3, testable)
