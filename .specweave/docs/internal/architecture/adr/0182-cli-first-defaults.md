# ADR-0182: CLI-First Defaults Philosophy
...
SpecWeave's current project selection UI follows GUI conventions (nothing selected by default), requiring users to manually select 45 out of 50 projects.
