...
- [Monolith](./terms/monolith) - Single-tier application
...
- [IaC (Infrastructure as Code)](./terms/iac) - Infrastructure through code
- [Terraform](./terms/terraform) - IaC tool for cloud infrastructure
- [Kubernetes (K8s)](./terms/kubernetes) - Container orchestration
- [Docker](./terms/docker) - Container platform
...
- [E2E (End-to-End) Testing](./terms/e2e) - Full workflow testing
- [Integration Testing](./terms/integration-testing) - Component interaction testing
- [Unit Testing](./terms/unit-testing) - Individual function testing
- [TDD (Test-Driven Development)](./terms/tdd) - Tests-first approach
- [BDD (Behavior-Driven Development)](./terms/bdd) - Given/When/Then testing
- [Test Coverage](./terms/test-coverage) - % of code tested
- [Test Pyramid](./terms/test-pyramid) - Testing strategy
- [Regression Testing](./terms/regression-testing) - Re-testing after changes
- [Smoke Testing](./terms/smoke-testing) - Basic functionality check
...
- [Epic](./terms/epic) - Large story spanning sprints
- [Acceptance Criteria (AC)](./terms/acceptance-criteria) - Definition of done
- [Product Backlog](./terms/product-backlog) - Prioritized feature list
- [Jira](./terms/jira) - Project tracking tool
- [Azure DevOps (ADO)](./terms/azure-devops) - Microsoft DevOps platform
- [Milestone](./terms/milestone) - Project checkpoint
- [Release Management](./terms/release-management) - Version deployment

**[Learn More →](/docs/workflows/planning)**
...
- [GDPR](./terms/gdpr) - Data privacy regulation
- [HIPAA](./terms/hipaa) - Healthcare data regulation
- [SOC 2](./terms/soc2) - Security compliance
...
- [Rate Limiting](./terms/rate-limiting) - Request throttling
- [Profiling](./terms/profiling) - Performance analysis
...
- [Machine Learning (ML)](./terms/ml) - Algorithms that learn from data
- [LLM (Large Language Model)](./terms/llm) - AI language models
- [Model Training](./terms/model-training) - Teaching ML models
- [Inference](./terms/inference) - Using trained models
