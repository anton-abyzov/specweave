...
**Generated**: Mar 2, 2026 at 6:14:56 AM
**Period**: Last 30 days
...
| **Lead Time for Changes** | 16.4 hours | ⭐ High | ✅ |
...
**Current**: 16.4 hours (⭐ High)
**Percentiles**: P50 = 7.4h, P90 = 44.9h
...
- 📊 **Distribution**: 50% of changes deploy in 7.4h, 90% in 44.9h
...
### Recent Releases (35 in last 30 days)

- **[v1.0.349](https://github.com/anton-abyzov/specweave/releases/tag/v1.0.349)** - Mar 2, 2026
