...
const SOCIAL_LINKS = [
  ...
  {label: 'Discord', href: 'https://github.com/anton-abyzov/specweave/discussions', icon: DiscordIcon},
  {label: 'YouTube', href: 'https://github.com/anton-abyzov/specweave', icon: YouTubeIcon},
