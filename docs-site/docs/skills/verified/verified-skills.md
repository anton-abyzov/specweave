...
For the full threat landscape, platform comparison, and risk taxonomy, see the [Skills Ecosystem Security](/docs/skills/verified/skills-ecosystem-security) page.
...
These sections make skill behavior transparent and auditable. The full specification with compliant examples is in the [Secure Skill Factory Standard RFC](/docs/skills/verified/secure-skill-factory-standard).
...
The `vskill` CLI provides command-line access to the registry. Use any package runner:
...
# bun
bunx vskill search "react components"

# pnpm
pnpx vskill search "react components"

# yarn
yarn dlx vskill search "react components"
```
