...
description: "Hands-on projects to reinforce your learning"
---
...
|------|----------------|------------------|
| [Part 2: CLI Foundation](./01-cli-foundation) | Task CLI | Node.js, modules, file I/O |
| [Part 3: Testing](./02-testing) | Test suite | Unit, integration, E2E |
| [Part 4: Quality](./03-quality) | Linting, types | ESLint, TypeScript |
| [Part 5: Full-Stack](./04-full-stack) | API + React UI | Express, React, database |
| [Part 6: DevOps](./05-devops) | CI/CD pipeline | GitHub Actions, Docker |
| [Part 7: Environments](./06-environments) | Multi-env deploy | Dev, staging, prod |
| [Part 8: Architecture](./07-architecture) | Microservices | Service separation |
| [Part 9: Scale](./08-scale) | Performance | Caching, optimization |
| [Part 10: Security](./09-security) | Auth, encryption | JWT, bcrypt, helmet |
| [Part 11: Enterprise](./10-enterprise) | Multi-tenant | Teams, permissions |
...
→ [Begin: CLI Foundation](./01-cli-foundation)
