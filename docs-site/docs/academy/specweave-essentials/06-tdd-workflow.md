...
```bash
sw:do     # Full orchestration
sw:do       # Write failing tests
sw:do     # Implement to pass
sw:do  # Clean up code
```
...
|---------|-------|---------|
| `sw:do` | All | Full orchestration |
| `sw:do` | RED | Write failing tests |
| `sw:do` | GREEN | Implement to pass |
| `sw:do` | REFACTOR | Improve code |
