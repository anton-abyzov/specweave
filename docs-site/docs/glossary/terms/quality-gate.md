...
Validates specifications before starting implementation. Say "assess quality before we start", use `sw:review 0001` in Claude Code, or type `qa 0001 --pre` in other AI tools.
...
Comprehensive quality check before release. Say "full quality assessment", use `sw:review 0001` in Claude Code, or type `qa 0001 --gate` in other AI tools.
