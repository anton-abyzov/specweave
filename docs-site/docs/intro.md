---
sidebar_position: 1
title: SpecWeave - Program Your AI in English
description: Skills are programs written in English — reusable, extensible, shareable. Describe what you want, AI asks the right questions, builds it while you sleep. Review in the morning.
keywords: [specweave, ai coding, autonomous agents, claude code, living documentation, spec-driven development, ai memory, claude, skills]
...
```mermaid
flowchart LR
    A["💡 Describe"] --> B["🎤 AI Interviews You"]
    B --> C["📋 spec + plan + tasks"]
    C --> D["🤖 Autonomous Build"]
    D --> E["☀️ Review in Morning"]
