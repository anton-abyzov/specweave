...
- Use `/specweave.close-previous` to close incomplete work
...
3. Explicit closure via `/specweave.close-previous`
...
- `/specweave.close-previous` - Interactive closure of incomplete increments

### Documentation Sync
- `/sync-docs review` - Review strategic docs before implementation
- `/sync-docs update` - Update living docs from completed increments
...
**A**: NO! (v0.6.0+) The framework **blocks** you. Use `/specweave.status` to check, `/specweave.close-previous` to close.
