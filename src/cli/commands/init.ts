  ...
  try {
    ...
    if (toolName === 'claude') {
      ...
      if (!isCommandAvailableSync('claude')) {
        ...
        console.log(chalk.gray('Claude Code is an npm package: @anthropic-ai/claude-code'));
        console.log('');
        console.log(chalk.cyan('Options:'));
        console.log('');
        console.log(chalk.white('1️⃣  Install Claude Code CLI (Recommended):'));
        console.log('');
        ...
        console.log('');
        console.log(chalk.white('2️⃣  Skip CLI - Use Claude Code App Directly:'));
        console.log(chalk.gray('   → Open project folder in Claude Code IDE'));
        console.log(chalk.gray('   → Type: /plugin install specweave@specweave'));
        console.log(chalk.gray('   → Plugins work without CLI configuration!'));
        console.log('');
