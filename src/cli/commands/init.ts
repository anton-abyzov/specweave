  ...
  try {
    ...
    if (toolName === 'claude') {
      ...
      if (!isCommandAvailableSync('claude')) {
        ...
        console.log('');
        console.log(chalk.white('SpecWeave needs the Claude Code CLI to auto-configure plugins.'));
        console.log(chalk.gray('The CLI comes bundled with the Claude Desktop app.'));
        console.log('');
        ...
        console.log(chalk.gray('           → Windows: Run the installer'));
        console.log(chalk.gray('           → Linux: Follow installation instructions'));
        console.log('');
        console.log(chalk.gray('   Step 3: Verify installation'));
        console.log(chalk.cyan('           → Open new terminal window'));
        console.log(chalk.cyan('           → Run: claude --version'));
        console.log(chalk.gray('           → Should show version number (e.g., 0.1.0)'));
        console.log('');
        console.log(chalk.gray('   Step 4: Re-run initialization'));
        console.log(chalk.cyan('           → specweave init'));
        console.log('');
        console.log(chalk.white('2️⃣  Manual Plugin Installation (If CLI Already Installed):'));
        console.log(chalk.gray('   → Open project folder in Claude Code'));
        console.log(chalk.gray('   → Run command: /plugin install specweave@specweave'));
        console.log(chalk.gray('   → Plugins will be available immediately'));
        console.log('');
        ...
        console.log('');
        console.log(chalk.yellow('💡 Tip: The `claude` command should be available globally after'));
        console.log(chalk.yellow('   installing Claude Desktop. If not, restart your terminal.'));
        console.log('');
