...
function getBrownfieldStrings(language: SupportedLanguage): {
  ...
  const strings: Record<SupportedLanguage, ReturnType<typeof getBrownfieldStrings>> = {
    en: {
      ...
      skipped: 'Skipping brownfield analysis. You can run it later with /sw:analyze-brownfield',
      ...
      depthQuick: 'Quick - Structure + imports + basic inconsistencies + diagrams',
      depthStandard: 'Standard - Full analysis + dependencies + team detection + relationships',
      depthDeep: 'Deep - AI-powered semantic analysis + enterprise KB (runs across sessions)',
      starting: '✓ Brownfield analysis configured',
      monitorHint: 'Analysis will run as background job. Monitor with: /sw:jobs',
      discrepancyTypes: [
    ...
    ru: {
      ...
      skipped: 'Пропуск анализа браунфилда. Запустите позже: /sw:analyze-brownfield',
      ...
      depthQuick: 'Быстрый - Структура + импорты + базовые несоответствия + диаграммы',
      depthStandard: 'Стандартный - Полный анализ + зависимости + определение команд + связи',
      depthDeep: 'Глубокий - AI семантический анализ + база знаний предприятия (работает между сессиями)',
      starting: '✓ Анализ браунфилда настроен',
      monitorHint: 'Анализ запустится в фоне. Мониторинг: /sw:jobs',
      discrepancyTypes: [
    ...
    es: {
      ...
      skipped: 'Omitiendo análisis brownfield. Ejecútelo después: /sw:analyze-brownfield',
      ...
      depthQuick: 'Rápido - Estructura + imports + inconsistencias + diagramas',
      depthStandard: 'Estándar - Análisis completo + dependencias + detección equipos + relaciones',
      depthDeep: 'Profundo - Análisis AI semántico + KB empresa (ejecuta entre sesiones)',
      starting: '✓ Análisis brownfield configurado',
      monitorHint: 'El análisis se ejecutará en segundo plano. Monitorear: /sw:jobs',
      discrepancyTypes: [
    ...
    zh: {
      ...
      skipped: '跳过棕地分析。稍后运行: /sw:analyze-brownfield',
      detectedDocs: '发现现有文档:',
      ...
      starting: '✓ 棕地分析已配置',
      monitorHint: '分析将作为后台任务运行。监控: /sw:jobs',
      discrepancyTypes: [
        '未文档化的公共API',
        '过时的文档',
        '缺失的ADR',
    ...
    de: {
      ...
      skipped: 'Brownfield-Analyse übersprungen. Später ausführen: /sw:analyze-brownfield',
      ...
      monitorHint: 'Analyse läuft im Hintergrund. Überwachen: /sw:jobs',
      discrepancyTypes: [
    ...
    fr: {
      ...
      skipped: 'Analyse brownfield ignorée. Exécutez plus tard: /sw:analyze-brownfield',
      ...
      depthQuick: 'Rapide - Structure + imports + incohérences + diagrammes',
      depthStandard: 'Standard - Analyse complète + dépendances + détection équipes + relations',
      depthDeep: 'Profond - Analyse AI sémantique + KB entreprise (exécute entre sessions)',
      starting: '✓ Analyse brownfield configurée',
      monitorHint: 'L\'analyse s\'exécutera en arrière-plan. Surveiller: /sw:jobs',
      discrepancyTypes: [
    ...
    ja: {
      ...
      skipped: 'ブラウンフィールド分析をスキップ。後で実行: /sw:analyze-brownfield',
      ...
      monitorHint: '分析はバックグラウンドジョブとして実行。監視: /sw:jobs',
      discrepancyTypes: [
        '未文書化のパブリックAPI',
        '古いドキュメント',
        '欠落しているADR',
    ...
    ko: {
      ...
      skipped: '브라운필드 분석 건너뜀. 나중에 실행: /sw:analyze-brownfield',
      detectedDocs: '발견된 문서:',
      ...
      monitorHint: '분석은 백그라운드 작업으로 실행됩니다. 모니터링: /sw:jobs',
      discrepancyTypes: [
        '문서화되지 않은 공개 API',
        '오래된 문서',
        '누락된 ADR',
    ...
    pt: {
      ...
      skipped: 'Análise brownfield ignorada. Execute depois: /sw:analyze-brownfield',
      ...
      depthQuick: 'Rápido - Estrutura + imports + inconsistências + diagramas',
      depthStandard: 'Padrão - Análise completa + dependências + detecção equipes + relações',
      depthDeep: 'Profundo - Análise AI semântica + KB empresa (executa entre sessões)',
      starting: '✓ Análise brownfield configurada',
      monitorHint: 'A análise será executada em segundo plano. Monitorar: /sw:jobs',
      discrepancyTypes: [
