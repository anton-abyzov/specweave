...
function getApiDocsStrings(language: SupportedLanguage): {
  ...
  const strings: Record<SupportedLanguage, ReturnType<typeof getApiDocsStrings>> = {
    ...
    fr: {
      ...
      timingManual: 'Manuel uniquement)',
