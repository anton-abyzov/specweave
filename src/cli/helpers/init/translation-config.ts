...
function getTranslationStrings(language: SupportedLanguage): {
  ...
  const strings: Record<SupportedLanguage, ReturnType<typeof getTranslationStrings>> = {
    en: {
      ...
      manualHint: 'use /specweave:translate manually',
    ...
    ru: {
      ...
      manualHint: 'используйте /specweave:translate вручную',
    ...
    es: {
      ...
      manualHint: 'use /specweave:translate manualmente',
    ...
    zh: {
      ...
      disabled: '翻译：已禁用',
      manualHint: '手动使用 /specweave:translate',
    ...
    de: {
      ...
      manualHint: 'verwenden Sie /specweave:translate manuell',
    ...
    fr: {
      ...
      manualHint: 'utilisez /specweave:translate manuellement',
    ...
    ja: {
      ...
      disabled: '翻訳：無効',
      manualHint: '手動で /specweave:translate を使用',
    ...
    ko: {
      ...
      disabled: '번역: 비활성화됨',
      manualHint: '수동으로 /specweave:translate 사용',
