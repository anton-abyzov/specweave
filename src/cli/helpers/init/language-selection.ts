 ...
 *
 * NOTE: Flag emojis render as 2-letter ISO country codes (GB, ES, etc.) on some terminals.
 * This is acceptable - the codes are intuitive and provide visual distinction.
 */
