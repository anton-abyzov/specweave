 ...
 *
 * Spawns clone and marketplace-scan workers as detached processes that
 * survive terminal close. Progress is tracked under .specweave/state/jobs/.
 */
...
import type { BackgroundJob, CloneJobConfig, MarketplaceScanJobConfig } from './types.js';
