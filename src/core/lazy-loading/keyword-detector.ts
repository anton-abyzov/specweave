...
const KEYWORD_PLUGIN_MAP: Record<string, string[]> = {
  ...
  responsive: ['specweave-frontend'],
  'landing page': ['specweave-frontend'],
  'user interface': ['specweave-frontend'],
  'design system': ['specweave-frontend'],
  shadcn: ['specweave-frontend'],
  radix: ['specweave-frontend'],
  chakra: ['specweave-frontend'],
  mui: ['specweave-frontend'],
  'material-ui': ['specweave-frontend'],
  'ant design': ['specweave-frontend'],
  bootstrap: ['specweave-frontend'],
  spa: ['specweave-frontend'],
  ssr: ['specweave-frontend'],
  ssg: ['specweave-frontend'],
  ...
  postgresql: ['specweave-backend'],
  mysql: ['specweave-backend'],
  ...
  authentication: ['specweave-backend'],
  jwt: ['specweave-backend'],
  oauth: ['specweave-backend'],
  microservice: ['specweave-backend'],
  microservices: ['specweave-backend'],
  server: ['specweave-backend'],
  orm: ['specweave-backend'],
  prisma: ['specweave-backend'],
  sequelize: ['specweave-backend'],
  typeorm: ['specweave-backend'],
  drizzle: ['specweave-backend'],
  dotnet: ['specweave-backend'],
  '.net': ['specweave-backend'],
