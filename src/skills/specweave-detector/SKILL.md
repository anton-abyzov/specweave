...
# 2. Parses intent: "add feature" + "payment processing"
...
### Complex Intent (Multiple Skills)
...
```
1. Parse Intent: BUILD + FEATURE + REAL_TIME_CHAT
   Intent: feature_creation + complex_feature
...
3. Detect next intent: User likely wants to implement
...
logRoutingDecision({
  ...
  parsedIntent: "feature_creation + payments",
...
### TC-004: Handle Ambiguous Intent
- Given: User says "Help with auth"
- When: specweave-detector cannot determine clear intent
...
- ✅ Parses user intent intelligently
