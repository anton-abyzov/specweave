...
**Default**: `@playwright/cli` (CLI-only mode, 98% token reduction)
**Install**: `npm install -g @playwright/cli@latest`
**Optional**: Playwright MCP plugin available via `claude plugin install playwright@claude-plugins-official`
<!-- SW:END:testing -->
