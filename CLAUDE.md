<!-- SW:META template="claude" version="1.0.163" sections="header,start,autodetect,metarule,rules,workflow,reflect,context,structure,taskformat,secrets,syncing,testing,tdd,api,limits,troubleshooting,lazyloading,principles,linking,mcp,auto,docs" -->

<!-- SW:SECTION:header version="1.0.163" -->
...
<!-- SW:SECTION:start version="1.0.163" -->
## Getting Started
...
<!-- SW:SECTION:autodetect version="1.0.163" -->
## Auto-Detection
...
<!-- SW:SECTION:metarule version="1.0.163" -->
...
<!-- SW:SECTION:rules version="1.0.163" -->
## Rules
...
<!-- SW:SECTION:workflow version="1.0.163" -->
## Workflow
...
<!-- SW:SECTION:reflect version="1.0.163" -->
## Skill Memories
...
<!-- SW:SECTION:context version="1.0.163" -->
## Context
...
<!-- SW:SECTION:structure version="1.0.163" -->
## Structure
...
<!-- SW:SECTION:taskformat version="1.0.163" -->
## Task Format
...
<!-- SW:SECTION:secrets version="1.0.163" -->
## Secrets Check
...
<!-- SW:SECTION:syncing version="1.0.163" -->
...
<!-- SW:SECTION:testing version="1.0.163" -->
## Testing
...
<!-- SW:SECTION:tdd version="1.0.163" -->
## TDD Mode (Test-Driven Development)

**⚠️ CRITICAL: TDD is an EXECUTION practice, NOT a planning practice.**

- **Planning** (`/sw:increment`): ALWAYS creates standard templates
- **Execution** (`/sw:do`, `/sw:tdd-*`): Enforces TDD discipline when configured

### When TDD Applies

| Phase | TDD Active? | What Happens |
|-------|-------------|--------------|
| `/sw:increment` | ❌ No | Standard templates created |
| `/sw:do` | ✅ Yes | TDD enforced if `testMode: "TDD"` |
| `/sw:tdd-cycle` | ✅ Yes | Full RED-GREEN-REFACTOR workflow |

### TDD Workflow (EXECUTION only)
...
<!-- SW:SECTION:api version="1.0.163" -->
...
<!-- SW:SECTION:limits version="1.0.163" -->
## Limits

**Max 1500 lines/file** — extract before adding
<!-- SW:END:limits -->

<!-- SW:SECTION:troubleshooting version="1.0.163" -->
## Troubleshooting
...
<!-- SW:SECTION:lazyloading version="1.0.163" -->
## Plugin Auto-Loading
...
<!-- SW:SECTION:principles version="1.0.163" -->
## Principles
...
<!-- SW:SECTION:linking version="1.0.163" -->
...
<!-- SW:SECTION:mcp version="1.0.163" -->
## External Services
...
<!-- SW:SECTION:auto version="1.0.163" -->
## Auto Mode
...
<!-- SW:SECTION:docs version="1.0.163" -->
## Docs
