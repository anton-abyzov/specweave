...
- Commands: /specweave.inc, /specweave.do, /specweave.progress, /sync-docs
...
- `/specweave.inc`, `/specweave.do`, `/specweave.next`, `/specweave.done`, `/specweave.progress`, `/specweave.validate`, `/sync-docs`
- `living docs`
