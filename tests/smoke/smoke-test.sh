...
test_command "review skill exists" "test -f $PROJECT_ROOT/plugins/specweave/skills/review/SKILL.md"
test_command "team skill exists" "test -f $PROJECT_ROOT/plugins/specweave/skills/team/SKILL.md"
