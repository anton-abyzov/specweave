...
import { loadIncrementMetadata, detectRepo, postScopeChangeComment } from './github-issue-updater.js';
import { execFileNoThrow } from '../../../src/utils/execFileNoThrow.js';
/**
 * Sync increment file changes to GitHub
 */
export async function syncIncrementChanges(incrementId, changedFile) {
...
async function syncSpecChanges(incrementId, issueNumber, owner, repo) {
    ...
    await postScopeChangeComment(issueNumber, {
        added: changes.added,
...
//# sourceMappingURL=github-sync-increment-changes.js.map