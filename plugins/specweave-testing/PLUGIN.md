...
Comprehensive testing infrastructure expert covering unit testing (Vitest/Jest), integration testing, E2E testing (Playwright/Cypress), visual regression, accessibility testing, and TDD workflows.
