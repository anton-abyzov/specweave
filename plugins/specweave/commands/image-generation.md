...
## CRITICAL: Health Check First (MANDATORY)

**BEFORE generating any image, ALWAYS run this CONTENT-BASED health check:**

WARNING: HTTP 200 status is NOT sufficient! Pollinations may return 200 but with error text instead of image data. **ALWAYS verify the response is actually an image.**
...
- Generation time: 30-120 seconds (varies by queue)
