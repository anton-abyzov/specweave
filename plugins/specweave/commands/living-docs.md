...
│
├── enterprise/                 # Enterprise KB (Phase G)
...
│
├── delivery/                   # Delivery documentation (Phase G)
...
│
└── diagrams/                   # Mermaid diagrams (Phase H)
