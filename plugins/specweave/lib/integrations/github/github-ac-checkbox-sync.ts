...
import { Logger, consoleLogger } from '../../vendor/utils/logger.js';
import { deriveFeatureId } from '../../vendor/utils/feature-id-derivation.js';
import {
  ProviderRouter,
  GitHubRepoConfig,
} from '../../vendor/sync/provider-router.js';
import {
  isProviderEnabled,
} from '../../vendor/sync/status-mapper.js';
import { resolvePermissions, SyncPreset } from '../../vendor/sync/config.js';
