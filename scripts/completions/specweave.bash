...
_specweave_completions() {
    ...
    case "${prev}" in
        ...
        create-increment)
            ...
            ;;
        handoff)
            COMPREPLY=( $(compgen -W "--reason --summary --next --gotcha --decision --inline --clipboard --non-specweave --out --json --push --keep-claims --help" -- "${cur}") )
            return 0
            ;;
        pickup)
            COMPREPLY=( $(compgen -W "--json --help" -- "${cur}") )
